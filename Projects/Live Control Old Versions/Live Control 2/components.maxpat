...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 832.0, 588.0, 60.0, 20.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 2418.0, 615.0, 42.0, 18.0 ],
					"text" : "loopC"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 830.0, 30.0, 800.0, 580.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 815.0, 15.0, 800.0, 580.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1618.0, 615.0, 41.0, 18.0 ],
					"text" : "loopB"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 832.0, 615.0, 41.0, 18.0 ],
					"text" : "loopA"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 841.5, 642.0, 808.5, 642.0, 808.5, -10.0, 809.5, -10.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 1627.5, 642.0, 1609.5, 642.0, 1609.5, -10.0, 1609.5, -10.0 ],
					"source" : [ "obj-14", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 2427.5, 642.0, 2407.5, 642.0, 2407.5, -10.0, 2409.5, -10.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 841.5, 611.0, 1627.5, 611.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 841.5, 611.0, 2427.5, 611.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "page1_maxinome.maxpat",
				"bootpath" : "/Users/themitchell/Desktop/Live Control/Live Control 2/LIVE CONTROL PATCH",
				"patcherrelativepath" : "",
				"type" : "JSON",
				"implicit" : 1
			}
